    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-[92vw] max-w-[560px] bg-[hsl(var(--dark-navy))] text-[hsl(var(--cream))] border border-white/10 rounded-2xl shadow-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <label className="text-sm">
            ...
            <input
              ...
              className="w-full rounded-lg bg-white/10 border border-white/20 px-3 py-2 outline-none focus:ring-2 focus:ring-[hsl(var(--gold))]"
              min={today}
            />
          </label>
          <label className="text-sm">
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-[12px] border border-white/20 text-[hsl(var(--cream))] hover:bg-white/10"
          >
            Cancel
          </button>
          <button
